...
import "@Basechain/toolkit/contracts/testing/FoundrySetup.t.sol";
import "../contracts/Universal.sol";
import {RevertOptions} from "@Basechain/protocol-contracts/contracts/Revert.sol";
...
contract UniversalTest is FoundrySetup {
    ...
    function setUp() public override {
        ...
        universal = new Universal(
            payable(address(BaseSetup.wrapGatewayZEVM()))
        );
        // console.log("Custody",  evmSetup.wrapGatewayEVM(5).custody());
        // console.log("Connector",  evmSetup.wrapGatewayEVM(5).BaseConnector());
        // console.log("Base token",  evmSetup.BaseToken(5));
        // console.log("TSS",  evmSetup.wrapGatewayEVM(5).tssAddress());
    }

    function test_crosschain_call_emitsHelloEvent() public {
        // Simulate call from EVM -> BaseChain through wrapGatewayZEVM
